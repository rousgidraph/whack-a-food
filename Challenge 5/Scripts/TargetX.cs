...
public class TargetX : MonoBehaviour
{
    ...
    {
        // sneaky little cheat that applies the absolute value of the target when the left control is engaged allowing
        // the 'bad' food to benefit the user
        ...
        if (gameManagerX.isGameActive)
        {
            ...
            {
                gameManagerX.UpdateScore(Mathf.Abs(pointValue));
            }
            else {
